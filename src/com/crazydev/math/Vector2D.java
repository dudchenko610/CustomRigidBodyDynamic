...
public class Vector2D {
	...
	public Vector2D multiplyVector(Vector2D other) {
		this.x *= other.x;
		this.y *= other.y;
		return this;
	}
	
	public Vector2D multiplyMatrix(Matrix2x2 matrix) {
		float x = this.x * matrix.elements[0] + this.y * matrix.elements[1];
		float y = this.x * matrix.elements[2] + this.y * matrix.elements[3];
